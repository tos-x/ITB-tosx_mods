...
return {
	CEO_Watchtower = {
		...
		Failure = {
			...
			"Your targeting data was inadequate. We've exhausted our long-range ordnance with nothing to show for it.",
		},
		Success = {
			"Your guidance telemetry was flawless. We will use it to update our missile batteries and improve future performance.",
			"Well done. Those missiles were not wasted.",
		},
	},
}